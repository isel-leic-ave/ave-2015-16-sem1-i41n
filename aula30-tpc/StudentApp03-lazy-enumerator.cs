...
static class App
{
    ...
    static IEnumerable<TSource> Distinct<TSource>(this IEnumerable<TSource> src){ return src; }
    
    static IEnumerable<TSource> Skip<TSource>(this IEnumerable<TSource> src, int count) { return src; }
